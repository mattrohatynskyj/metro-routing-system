...
def show_landmarks():
    answer = input("Would you like to see the list of landmarks again? Enter y/n: ")
    if answer == "y":
...
def set_start_and_end(start_point, end_point):
    if start_point is not None:
        change_point = input(
            "What would you like to change? Type 'o' for origin, 'd' for destination, or 'b' for both: "
        )
        if change_point == "b":
            ...
            print("Oops, that isn't 'N', 'E', or 'B'...")
